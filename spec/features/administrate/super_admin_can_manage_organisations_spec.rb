describe "Super admin can manage organisations" do
  ...
  context "from organisation admin show page" do
    ...
    it "can see an organisation's details" do
      ...
      expect(page).to have_css("dt", id: "logo_filename", text: "NOM DU LOGO")
  ...
  context "from organisation admin edit page" do
    ...
    it "can edit an organisation" do
      ...
      expect(page).to have_css("label[for=\"organisation_logo_filename\"]", text: "Nom du logo")
      expect(page).to have_field("organisation[logo_filename]", with: organisation1.logo_filename)
      expect(page).to have_button("Enregistrer")
