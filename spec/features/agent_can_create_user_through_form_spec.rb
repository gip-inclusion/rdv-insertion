describe "Agents can create user through form", :js do
  ...
  describe "#create" do
    ...
    it "creates an user" do
      ...
      expect(user.versions.last.whodunnit).to include("[Agent]")
      expect(user.versions.last.whodunnit).to include(agent.email)
    end
      ...
      context "through nir" do
        ...
        let!(:user) do
          create(
            ...
            rdv_solidarites_user_id: rdv_solidarites_user_id, department:
          )
        end
        ...
        context "for creation origin attributes" do
          let!(:user) do
            create(
              ...
              created_through: "rdv_insertion_upload_page", created_from_structure: department, department:
            )
          end
