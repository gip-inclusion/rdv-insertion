describe CreneauOpeningRequestsController do
  ...
  describe "#redirect_shortcut" do
    subject(:perform_action) { get :redirect_shortcut, params: { uuid: creneau_opening_request.uuid } }
  ...
  describe "#redirect" do
    subject(:perform_action) { get :redirect, params: { uuid: creneau_opening_request.uuid } }
    ...
    context "when the uuid does not exist" do
      subject(:perform_action) { get :redirect, params: { uuid: "UNKNOWN1" } }
