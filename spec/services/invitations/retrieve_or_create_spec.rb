  ...
  describe "#call" do
    ...
    context "invitation creation" do
      context "when the user has no invitation with the requested format" do
        let!(:invitation) { create(:invitation, organisation: organisation, applicant: applicant, format: "email") }
      ...
      context "when the user has already an invitation from that organisation with the requested format" do
        let!(:invitation) do
          create(:invitation, organisation: organisation, applicant: applicant, format: invitation_format)
        end
