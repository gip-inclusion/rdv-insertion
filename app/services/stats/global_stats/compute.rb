  ...
  module GlobalStats
    class Compute
      ...
      def rate_of_users_accompanied_in_less_than_15_days
        ...
        # - less than 15 days between accompaniment follow-up creation and their first seen RDV
        # - less than 15 days between their seen orientation RDV and their first seen accompaniment RDV
        ComputeFollowUpSeenRate.call(
          follow_ups: @stat.users_first_accompaniment_follow_up,
          target_delay_days: 15,
          consider_orientation_rdv: true
        ).value
      end
