class User < ApplicationRecord
  ...
  has_many :diagnostics,  -> { diagnostic }, class_name: "Document", dependent: :destroy, inverse_of: :user
  has_many :contracts, -> { contract }, class_name: "Document", dependent: :destroy, inverse_of: :user
