...
export default class User {
  ...
  asJson() {
    return {
      ...
      ...({ created_from_type: this.list.isDepartmentLevel ? "Department" : "Organisation" }),
      ...({ created_from_id: this.list.isDepartmentLevel ? this.department.id : this.currentOrganisation.id }),
    };
  }
}
