...
import { formatInput, formatAffiliationNumber, formatTags, formatDateInput, formatAddress, formatRole, formatTitle, formatPhoneNumber } from "../lib/userListInputFormatters"

export default class extends Controller {
  static targets = ["dropZone", "input", "uploadedFileInfo", "fileName", "fileInputInstruction", "userCount", "submitButton"]

  connect() {
    this.fileConfigurationColumnAttributes = JSON.parse(this.element.dataset.fileUploadFileConfigurationColumnAttributes)
    this.fileConfigurationSheetName = this.element.dataset.fileUploadFileConfigurationSheetName
  }
