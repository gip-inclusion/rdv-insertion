module TurboStreamConcern
  ...
  def turbo_stream_display_success_modal(message, title: "✅ Succès", reload_on_close: false, tally_form_id: nil)
    turbo_stream_display_modal(
      partial: "common/success_modal",
      locals: { message:, title:, reload_on_close:, tally_form_id: },
      status: :ok
    )
  end
