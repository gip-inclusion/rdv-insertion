module UserListUploads
  class UserListUploadsController < ApplicationController
    include SortParams
    ...
    def enrich_with_cnaf_data
      ...
      if @user_list_upload.update_rows(JSON.parse(params[:rows_data_by_uid]))
        ...
        turbo_stream_redirect(structure_user_list_upload_path(id: @user_list_upload.id))
      else
