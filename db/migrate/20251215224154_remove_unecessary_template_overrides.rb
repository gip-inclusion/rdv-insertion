  ...
  def change
    up_only do
      CategoryConfiguration.find_each do |category_configuration|
        ...
        if category_configuration.template_rdv_title_by_phone_override == category_configuration.template.rdv_title_by_phone
          category_configuration.template_rdv_title_by_phone_override = nil
        end
        if category_configuration.template_user_designation_override == category_configuration.template.user_designation
