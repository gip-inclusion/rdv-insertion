...
Participation
  ...
  Counters::UsersWithRdvTakenAutonomously.trigger_with(participation)
  Counters::UsersWithRdvTakenByAgent.trigger_with(participation)
  Counters::UsersWithRdvTakenByPrescripteur.trigger_with(participation)
